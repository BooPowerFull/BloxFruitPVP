...
toggleButton.Image = "rbxassetid://12090819004"
...
local Window = Library.CreateLib("Miku BF PvP ˃ᴗ˂  |  " .. executor, UiSettingsModule.currentTheme)
...
Section:NewButton("Join Discord", "Get Link Discord server", function()
	local link = "https://discord.gg/jrrVB3WK"
